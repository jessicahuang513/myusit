...
def initdb():
    ...
    db.session.add(User(firstName="Catherine", lastName="Cheng",email="president@usiteam.org", eid="aj24872", password="test11", roles=[admin], attendance = 0, dues = 0, atLatestMeeting = False, rowOnSheet = 0, analyst = 'Srija Nalla', fund='TMT'))
    db.session.add(User(firstName="Eric", lastName="Sun",email="vicepresident@usiteam.org", eid="aj24872", password="test11", roles=[admin], attendance = 0, dues = 0, atLatestMeeting = False, rowOnSheet = 0, analyst = 'Srija Nalla', fund='TMT'))
    db.session.add(User(firstName="Matt", lastName="Hopp",email="investment@usiteam.org", eid="aj24872", password="test11", roles=[admin], attendance = 0, dues = 0, atLatestMeeting = False, rowOnSheet = 0, analyst = 'Srija Nalla', fund='TMT'))
    db.session.add(User(firstName="Jessica", lastName="Huang",email="technology@usiteam.org", eid="jh65898", password="test11", roles=[admin], attendance = 0, dues = 0, atLatestMeeting = False, rowOnSheet = 0, analyst = 'Srija Nalla', fund='TMT'))
    db.session.commit()
    refreshdb()
